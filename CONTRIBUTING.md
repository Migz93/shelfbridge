...
- Call out release, Docker, auth, schema, sync, or credential-storage impact when relevant
...
See [TESTING.md](TESTING.md) for the current test and verification guide.

## Technical Docs

See [docs/README.md](docs/README.md) for the technical reference area.

If you are changing architecture, sync behavior, persistence, integrations, authentication, credential storage, or other long-lived internal behavior, update the relevant `docs/*.md` page in the same branch/PR. If no existing page fits, add a new topic doc and link it from `docs/README.md`.
