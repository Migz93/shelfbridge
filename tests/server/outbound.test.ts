...
test("integration URLs reject non-HTTP schemes, embedded credentials, and relative paths", () => {
  for (const value of ["ftp://example.test", "https://user:pass@example.test", "/api/v1"]) {
